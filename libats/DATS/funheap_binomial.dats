...
staload "libats/SATS/funheap_binomial.sats"
...
bheap_remove_min
  ...
  EXP2 (n2, p) | bheap (a, n1, sz-p), btree (a, n2)
) = let
  val+ bheap_cons (pf0 | bt0, hp1) = hp0
  val+ btnode (_, x0, _) = bt0
//
...
fun pow2 {n:nat} (n: int n)
  : [p:pos] (EXP2 (n, p) | size_t (p)) = "atslib_funheap_binomial_pow2"
// end of [pow2]

%{^
ats_size_type
atslib_funheap_binomial_pow2
  (ats_int_type n) {
