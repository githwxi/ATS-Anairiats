...
// end of [QUEUE]
//
typedef QUEUE0 (a:vt@ype) = QUEUE (a, 0)?
vtypedef QUEUE1 (a:vt@ype) = [n:nat] QUEUE (a, n)
//
(* ****** ****** *)
//
fun
...
fun
queue_is_empty
  {a:vt@ype}{n:nat}(q: &QUEUE (a, n)):<> bool (n <= 0)
...
queue_initialize
  {a:vt@ype}
  (q: &QUEUE0 a >> QUEUE (a, 0)):<> void
//
fun
{a:vt@ype}
queue_uninitialize
  {n:nat}
  (q: &QUEUE (a, n) >> QUEUE0 a):<> list_vt (a, n)
//
(* ****** ****** *)
...
{a:vt@ype}
queue_remove (*first*)
  {n:int | n > 0} (q: &QUEUE (a, n) >> QUEUE (a, n-1)):<> a
// end of [queue_remove]
