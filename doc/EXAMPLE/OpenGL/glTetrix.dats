...
theCurrentShape_xmove_if
  (delta: int): int = "theCurrentShape_xmove_if"
implement
theCurrentShape_xmove_if (delta) = let
  val S = !theCurrentShapeRef
...
theCurrentShape_ymove_if
  (delta: int): int = "theCurrentShape_ymove_if"
implement
theCurrentShape_ymove_if (delta) = let
  val S = !theCurrentShapeRef
  val ix_center = the_ix_center_get ()
  and iy_center = the_iy_center_get ()
  val rk = the_rotkind_get ()
...
(
) : void = "theCurrentShape_freefall"

implement
theCurrentShape_freefall () = let
...
theCurrentShape_rotate_if
  (delta: Nat): int = "theCurrentShape_rotate_if"
...
extern
fun
glTetrix_timer (flag: int): void = "glTetrix_timer"
