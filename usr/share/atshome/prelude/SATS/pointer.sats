...
[
  ...
  = "ext#atspre_ptr_alloc_tsz"
//
fun ptr_free
  {a:t@ype}{l:addr}
(
  pfgc: free_gc_v (a, l), pfat: a @ l | p: ptr l
) :<> void = "ext#atspre_ptr_free"
//
(* ****** ****** *)
...
(
  pf1: !v
, pf2: vsubr_p (a @ l1, v), pf3: !(a?) @ l2 >> a @ l2
| p1: ptr l1, p2: ptr l2
) :<> void // end of [ptr_move_t_main]

// implemented in [prelude/DATS/pointer.dats]
fun{a:t@ype}
ptr_move_t{l1,l2:addr}
...
ptr_move_vt
  {l1,l2:addr} (
  pf1: !a @ l1 >> (a?) @ l1
, pf2: !(a?) @ l2 >> a @ l2 | p1: ptr l1, p2: ptr l2
) :<> void // end of [ptr_move_vt]
//
// implemented in [prelude/CATS/pointer.cats]
//
fun
...
(
  pf1: !a @ l1 >> (a?) @ l1
, pf2: !(a?) @ l2 >> a @ l2 | p: ptr l1, p2: ptr l2, tsz: sizeof_t a
) :<> void = "ext#atspre_ptr_move_tsz"
//
(* ****** ****** *)

// implemented in [prelude/DATS/pointer.dats]
fun{a:t@ype}
ptr_get_inv {l:addr} (pf: !a @ l | p: ptr l):<> a

// implemented in [prelude/DATS/pointer.dats]
fun{a:t@ype}
ptr_set_inv {l:addr} (pf: !a @ l | p: ptr l, x: a):<> void
