...
val gdbm_version
  : string = "mac#atslib_gdbm_version" // pre-allocated
val gdbm_version_number
  : array (int, 3) = "mac#atslib_gdbm_version_number" // pre-allocated
// end of [gdbm_version_number]

(* ****** ****** *)

fun gdm_version_cmp
  (x: &(@[int][3]), y: &(@[int][3])):<> int = "mac#atslib_gdbm_version_cmp"
...
*)
fun gdbm_reorganize
  {lf:agz} (dbf: !GDBM_FILE lf): int = "mac#atslib_gdbm_reorganize"
...
*)
fun gdbm_sync
  {lf:agz} (dbf: !GDBM_FILE lf): void = "mac#atslib_gdbm_sync"
// end of [gdbm_sync]
...
fun gdbm_fdesc {lf:agz}
  (dbf: !GDBM_FILE lf): int(*fd*) = "mac#atslib_gdbm_fdesc"
// end of [gdbm_fdesc]
