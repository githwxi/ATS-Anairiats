...
ats_int_type
srand48_r
  (ats_lint_type seed, ats_drand48_data_type *buf) ;
//
ATSinline()
ats_int_type
atslib_srand48_r
...
extern
ats_int_type
drand48_r (ats_drand48_data_type *buf, double *res) ;
extern
ats_int_type
lrand48_r (ats_drand48_data_type *buf, ats_lint_type *res) ;
extern
ats_int_type
mrand48_r (ats_drand48_data_type *buf, ats_lint_type *res) ;
//
/* ****** ****** */
...
atslib_drand48_r
(
  ats_ref_type buf, ats_ref_type res
) {
  return drand48_r((ats_drand48_data_type*)buf, (double*)res) ;
} // end of [drand48_r]
