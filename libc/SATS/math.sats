...
fun{a:t@ype} atanhtmp (x: a):<> a
fun atanh (d: double):<> double = "mac#atslib_atanh"
fun atanhf (f: float):<> float = "mac#atslib_atanhf"
fun atanhl (ld: ldouble):<> ldouble = "mac#atslib_atanhl"
