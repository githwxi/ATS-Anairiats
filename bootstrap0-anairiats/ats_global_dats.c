...
/*
// /home/hwxi/research/Anairiats/src/ats_global.dats: 1899(line=61, offs=20) -- 1919(line=61, offs=40)
*/
ATSglobaldec()
ats_ptr_type
ATS_2d0_2e2_2e10_2src_2ats_global_2esats__the_IATSdirlst_get () {
/* local vardec */
ATSlocal (ats_ptr_type, tmp4) ;

__ats_lab_ATS_2d0_2e2_2e10_2src_2ats_global_2esats__the_IATSdirlst_get:
tmp4 = ats_ptrget_mac(ats_ptr_type, statmp0) ;
return (tmp4) ;
} /* end of [ATS_2d0_2e2_2e10_2src_2ats_global_2esats__the_IATSdirlst_get] */

/*
// /home/hwxi/research/Anairiats/src/ats_global.dats: 1951(line=64, offs=21) -- 2012(line=65, offs=54)
*/
ATSglobaldec()
ats_void_type
ATS_2d0_2e2_2e10_2src_2ats_global_2esats__the_IATSdirlst_push (ats_ptr_type arg0) {
/* local vardec */
// ATSlocal_void (tmp5) ;
ATSlocal (ats_ptr_type, tmp6) ;
ATSlocal (ats_ptr_type, tmp7) ;

__ats_lab_ATS_2d0_2e2_2e10_2src_2ats_global_2esats__the_IATSdirlst_push:
...
return /* (tmp5) */ ;
} /* end of [ATS_2d0_2e2_2e10_2src_2ats_global_2esats__the_IATSdirlst_push] */
...
ats_void_type
ATS_2d0_2e2_2e10_2src_2ats_global_2edats__staload () {
static int ATS_2d0_2e2_2e10_2src_2ats_global_2edats__staload_flag = 0 ;
if (ATS_2d0_2e2_2e10_2src_2ats_global_2edats__staload_flag) return ;
ATS_2d0_2e2_2e10_2src_2ats_global_2edats__staload_flag = 1 ;
...
extern ats_int_type ATS_2d0_2e2_2e10_2src_2ats_global_2edats__dynload_flag ;

ats_void_type
ATS_2d0_2e2_2e10_2src_2ats_global_2edats__dynload () {
ATS_2d0_2e2_2e10_2src_2ats_global_2edats__dynload_flag = 1 ;
ATS_2d0_2e2_2e10_2src_2ats_global_2edats__staload () ;
...
/* end of [/home/hwxi/research/Anairiats/bootstrap1/ats_global_dats.c] */
