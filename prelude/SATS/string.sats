...
(* ****** ****** *)
//
// val string_empty : string 0 // this is not really necessary
//
(* ****** ****** *)
//
...
fun
string_make_array0(A: array0(char)): Strptr1
...
fun stropt_is_none{i:int}
  (stropt: stropt i):<> bool (i < 0) = "atspre_stropt_is_none"
fun stropt_is_some{i:int}
  (stropt: stropt i):<> bool (i >= 0) = "atspre_stropt_is_some"

fun fprint_stropt
  (out: FILEref, stropt: Stropt): void = "atspre_fprint_stropt"
overload fprint with fprint_stropt
