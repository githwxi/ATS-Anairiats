...
overload assert with assert_bool // of 10

fun assert_bool1
  {b:bool} (
  assertion: bool b
) :<!exn> [b] void = "atspre_assert"
overload assert with assert_bool1 // of 11
...
assert_errmsg_bool
(
  prop: bool, msg: string
) :<!exn> void = "atspre_assert_errmsg"
overload assert_errmsg with assert_errmsg_bool // of 10

fun
assert_errmsg_bool1
  {b:bool}
(
  prop: bool b, msg: string
) :<!exn> [b] void = "atspre_assert_errmsg"
overload assert_errmsg with assert_errmsg_bool1 // of 11

(*
fun
assert_errmsg_bool1_string1
  {b:bool}
(
...
praxi free_gc_elim_t0ype_addr // return the certificate to the GC
  {a:t@ype} {l:addr} (pf: free_gc_v (a, l)): void
overload free_gc_elim with free_gc_elim_t0ype_addr
praxi free_gc_elim_t0ype_int_addr // return the certificate to the GC
  {a:t@ype} {n:int} {l:addr} (pf: free_gc_v (a, n, l)): void
overload free_gc_elim with free_gc_elim_t0ype_int_addr
//
(* ****** ****** *)
//
...
abstype
file_mode (file_mode) // string type
