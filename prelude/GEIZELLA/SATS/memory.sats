...
fun calloc_gc
  ...
  :<> [l:agz] (
  freebyte_gc_v (n, l), @[a?][n] @ l | ptr l
) = "ats_calloc_gc"
// end of [calloc_gc]

fun free_gc
  {n:nat} {l:addr} (
  pfgc: freebyte_gc_v (n, l)
, pfbuf: b0ytes n @ l
| p: ptr l
) :<> void
  = "ats_free_gc"
...
fun calloc_ngc
  ...
  (n: size_t n, tsz: sizeof_t a)
  :<> [l:addr] (
  calloc_v (a, n, l) | ptr l
) = "ats_calloc_ngc"
// end of [calloc_ngc]

fun free_ngc
  {n:nat} {l:addr} (
  pfgc: freebyte_ngc_v (n, l), pfbuf: b0ytes n @ l
| p: ptr l
) :<> void= "ats_free_ngc"
// end of [free_ngc]
...
fun realloc_ngc
  {n0,n:nat} {l0:addr} (
  pfgc: freebyte_ngc_v (n0, l0), pfbuf: b0ytes n0 @ l0
| p: ptr l0, n: size_t n
) :<> [l:addr] (
  realloc_v (n0, n, l0, l) | ptr l
) = "ats_realloc_ngc"
// en  dof [realloc_ngc]
